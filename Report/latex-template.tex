...
\author{
  Bjørnøy Håvard, Vik H. B. Hedda, Ulvøen Thomas \\
  \textit{Machine Learning Course, EPFL Lausanne, Switzerland}
}

\maketitle

\begin{abstract}
  In this project we apply fundamental machine learning algorithms to real data from the CERN supercollider, to find the Higgs boson. The Higgs boson is the particle that gives all matter its mass, and is one of the greatest discoveries of this century. The results from both standard and improved methods will be compared, etc etc etc... Our solution
 ...
 ...
 ...
\end{abstract}
